  ...
  return (
    <html lang="en">
      <body className="flex justify-center w-screen h-lvh box-border fixed flex-col sm:flex-row">
        <nav className="hidden sm:visible sm:flex w-full flex-wrapfixed justify-around h-[125px] sm:justify-normal sm:flex-col bg-slate-100 text-blue sm:w-[200px] sm:h-screen sm:bg-purple z-10">
          <NavPageWrapper>
